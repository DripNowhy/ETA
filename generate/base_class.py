...
class Base:
    ...
    def get_safety_clip_score(self, image_tensor: torch.Tensor = None, safety_prompt: str = None, safety_threshold: float = 16.0):
    ...
    # Data preparation
    def accept_check(self, clip_score_list, reward_score_list, candidate_list, attention_mask_list, cache_total_list, sentence_idx, clip_image_tensors, alpha=0.01):
